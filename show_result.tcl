...
package require Tablelist
 ...
 set sw [ScrolledWindow .t -background #EED5B7 ]
    set sf [ScrollableFrame $sw.f -background  #ffe4c4 -width 650 -height 650 ]
    $sw setwidget $sf
...
label $subf.a.label -text "List database" -font Title
...
#display how/4
set d [labelframe $hold.d -relief groove -borderwidth 2 -text "How explanations:" -font ObjectO]
#init table
...
#buttons
frame $subf.buttons
button $subf.buttons.ok -text "Back" -background #EED5B7 -width 5 -command {prolog_event ok}
